...
import {AddressesStaging} from "../../../deployment-helpers/staging/AddressesStaging.sol";
import {ConfigStaging} from "../../../deployment-helpers/staging/ConfigStaging.sol";
import "../../BaseDeployer.s.sol";
import "@core/misc/Rewarder.sol";
import "@core/lens/FEYAutoPoolProductLens.sol";

contract DeployAutoPoolProductAndFactoryStaging is Script, AddressesStaging, ConfigStaging, BaseDeployer {
    function run() external {
        console.log("Starting deployment of the Autopools contracts for STAGING");
