...
contract FEYAutoPoolProductDepositFor_UnitTest is FEYProductBaseTestSetup {
    function onSetup() public virtual override {
        depositInvestTestsFixture(seniorTrancheIsWAVAX);
    }

    function testDepositForAP_RevertInsufficientAllowance() public {
    ...
    function testDepositForAP_RevertACL() public {
    ...
    function testDepositForAP_RevertInsufficientBalance() public {
    ...
    function testDepositForAP_RevertWhenLocalPaused() public {
    ...
    function testDepositForAP_RevertWhenGlobalPaused() public {
    ...
    function testDepositForAP_ShouldThrowDifferentRevertMessageLocalUnpaused() public {
    ...
    function testDepositForAP_ShouldThrowDifferentRevertMessageGlobalUnpaused() public {
    ...
    function testDepositForAP_RevertDepositAmountExceedsCapacity() public {
    ...
    function testDepositForAP_RevertDepositsClosed() public {
    ...
    function testDepositForAP_SeniorUserInvestmentWithinCapacity() public {
    ...
    function testDepositForAP_JuniorUserInvestmentWithinCapacity() public {
    ...
    function testDepositForAP_ShouldMintSPTokens() public {
    ...
    function testDepositForAP_SeniorTranche_UserSumsDepositSums_SingleUser() public {
    ...
    function testDepositForAP_SeniorTranche_UserSumsDepositSums_MultipleUsers() public {
    ...
    function testDepositForAP_JuniorTranche_UserSumsDepositSums_SingleUser() public {
    ...
    function testDepositForAP_JuniorTranche_UserSumsDepositSums_MultipleUsers() public {
    ...
    function testDepositForAP_JuniorTranche_RevertInvariantCheckFailed() public {
        ...
        deal(address(usdc), address(factory), _amountToDeposit);
        vm.prank(address(factory));
        usdc.approve(address(sut), _amountToDeposit);
        ...
        vm.prank(address(factory));
        sut.depositForHarness(JUNIOR_TRANCHE, _amountToDeposit, address(user1));
    }

    function testDepositForAP_SeniorTranche_RevertInvariantCheckFailed() public {
        console.log("Pr_DepFr_27");
        console.log(
        ...
        deal(address(wavax), address(factory), _amountToDeposit);
        vm.prank(address(factory));
        wavax.approve(address(sut), _amountToDeposit);

        vm.mockCall(address(wavax), abi.encodeWithSelector(wavax.balanceOf.selector), abi.encode(0));
        vm.expectRevert(abi.encodePacked(Errors.VE_DEPOSIT_INVARIANT_CHECK));
        vm.prank(address(factory));
        sut.depositForHarness(SENIOR_TRANCHE, _amountToDeposit, address(user1));
    }
}
