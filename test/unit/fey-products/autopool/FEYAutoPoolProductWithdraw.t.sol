...
contract FEYAutoPoolProductWithdraw_UnitTest is FEYProductBaseTestSetup {
    ...
    function testWithdraw_RevertIfInvalidState() public {
        console.log("should revert when tried to withdraw when the tranche is not yet invested");
