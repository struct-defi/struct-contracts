...
/**
 * @title Autopool factory User contract
 * @notice User contract to interact with FEYAutopool Factory Contract.
 *
 */
contract AutoPoolFactoryUser is ERC1155Holder {
    ...
    function setPoolStatus(address _autoPoolvault, uint256 status) external {
        feyFactory.setPoolStatus(_autoPoolvault, status);
    }
    ...
    function setYieldSource(address autoPoolVault, address _yieldSource) external {
        feyFactory.setYieldSource(autoPoolVault, _yieldSource);
    }
